...
const Chatbot = () => {
  ...
  const responses = {
    ...
    'contacto': 'Puedes contactarnos al (123) 456-7890 o enviarnos un email a info@3mprnd.com',
    ...
    <div className="fixed bottom-4 right-4 z-50">
      {!isOpen ? (
        <button
          ...
          className="bg-[#948979] text-white p-4 rounded-full shadow-lg hover:bg-[#393E46] transition-colors"
        >
          💬
        </button>
      ) : (
        <div className="bg-white rounded-lg shadow-xl w-80 h-96 flex flex-col">
          <div className="bg-[#948979] text-white p-4 rounded-t-lg flex justify-between items-center">
          ...
          <div className="p-4 border-t">
            <div className="flex space-x-2">
              <input
                ...
                className="flex-1 border rounded-lg px-4 py-2 focus:outline-none focus:border-[#948979]"
              />
              <button
                onClick={handleSend}
                className="bg-[#948979] text-white px-4 py-2 rounded-lg hover:bg-[#393E46] transition-colors"
              >
                Enviar
              </button>
            </div>
