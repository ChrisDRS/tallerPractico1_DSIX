      ...
      <div className="max-w-md w-full space-y-8 p-10 bg-primary rounded-xl shadow-lg z-10">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              className={`group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-text bg-accent hover:bg-contrast focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
              disabled={loading}>
